...
//        int port = Integer.parseInt(args[1]);
        try
        {
            System.out.println("Connecting to " + InetAddress.getLocalHost() + " on port " + Constants.SERIAL_PORT);
            Socket client = new Socket(InetAddress.getLocalHost(), Constants.SERIAL_PORT);
